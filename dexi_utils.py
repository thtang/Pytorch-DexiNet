...
def dataset_info(dataset_name):
    config = {
        'BSDS': {'img_height':321,
                 ...
                 'data_dir': '/datasets/BSDS',  # mean_rgb
                    'yita': 0.5},
        'BSDS300': {'img_height': 321,
                 'img_width': 481,
                'file_name': 'test_pair.lst',
                 'data_dir': '/datasets/BSDS300',  # NIR
                 'yita': 0.5},
        'PASCAL': {'img_height':375,
                    'img_width':500,
                   'file_name': 'test_pair.lst',
                   'data_dir': '/datasets/PASCAL',  # mean_rgb
                           'yita': 0.3},
        'CID': {'img_height':512,
                   'img_width':512,
                'file_name': 'test_pair.lst',
                   'data_dir': '/datasets/CID',  # mean_rgb
                   'yita': 0.3},
        'NYUD': {'img_height':425,
                    'img_width':560,
                 'file_name': 'test_pair.lst',
                    'data_dir': '/datasets/NYUD',  # mean_rgb
                       'yita': 0.5},
        'MULTICUE': {'img_height':720,
                    'img_width':1280,
                     'file_name': 'test_pair.lst',
                     'data_dir': os.path.join('datasets','MULTICUE'),  # mean_rgb
                          'yita': 0.3},
        'BIPED': {'img_height': 720,
                   'img_width': 1280,
                  'file_name': 'test_rgb.lst',
                   'data_dir': os.path.join('datasets','BIPED','edges'),  # mean_rgb
                   'yita': 0.5},
        ...
        'DCD': {'img_height': 240,
                  'img_width': 360,
                  'file_name':'test_pair.lst',
                  'data_dir': '/datasets/DCD',  # mean_rgb
                  'yita': 0.2}
    }
